...
<div class="container ">
    <div class="row">
        ...
        <div class="col-md-6 col-lg-6  position-absolute top-50 start-50 translate-middle card-box">
            <form class="row g-3" method="post" action="<?= base_url("home/book/$id"); ?>">
                <div class="col-md-12">
                    <label for="id" class="form-label text-light">Facility ID</label>
                    <input type="text" class="form-control" id="id" name="id" value="<?php echo $data->Facility_ID ?>" disabled>
                </div>
                <div class="col-md-12">
